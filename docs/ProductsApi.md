...
> Array&lt;VulnerabilityItem&gt; repositories_repo_name_tags_tag_vulnerability_details_get(repo_name, tag)
...
begin
  #Get vulnerability details of the image.
  result = api_instance.repositories_repo_name_tags_tag_vulnerability_details_get(repo_name, tag)
  p result
rescue SwaggerClient::ApiError => e
  puts "Exception when calling ProductsApi->repositories_repo_name_tags_tag_vulnerability_details_get: #{e}"
end
```
...
[**Array&lt;VulnerabilityItem&gt;**](VulnerabilityItem.md)
...
# **users_user_id_gen_cli_secret_post**
> InlineResponse200 users_user_id_gen_cli_secret_post(user_id)
...
begin
  #Generate new CLI secret for a user.
  result = api_instance.users_user_id_gen_cli_secret_post(user_id)
  p result
rescue SwaggerClient::ApiError => e
  puts "Exception when calling ProductsApi->users_user_id_gen_cli_secret_post: #{e}"
end
```
