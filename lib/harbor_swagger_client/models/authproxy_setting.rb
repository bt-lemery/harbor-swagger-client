...
module SwaggerClient
  class AuthproxySetting
    ...
    attr_accessor :tokenreivew_endpoint
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'tokenreivew_endpoint')
        self.tokenreivew_endpoint = attributes[:'tokenreivew_endpoint']
      end

      if attributes.has_key?(:'skip_search')
        self.skip_search = attributes[:'skip_search']
      end
      ...
      if attributes.has_key?(:'server_certificate')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          endpoint == o.endpoint &&
          tokenreivew_endpoint == o.tokenreivew_endpoint &&
          skip_search == o.skip_search &&
    ...
    def hash
      [endpoint, tokenreivew_endpoint, skip_search, verify_cert, server_certificate].hash
    end
