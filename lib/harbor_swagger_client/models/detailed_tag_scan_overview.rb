...
module SwaggerClient
  ...
  class DetailedTagScanOverview
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'details_key')
        self.details_key = attributes[:'details_key']
      end
    ...
    def hash
      [digest, scan_status, job_id, severity, details_key, components].hash
    end
