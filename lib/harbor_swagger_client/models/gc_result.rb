...
module SwaggerClient
  class GCResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'job_parameters')
        self.job_parameters = attributes[:'job_parameters']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          job_name == o.job_name &&
          job_kind == o.job_kind &&
          job_parameters == o.job_parameters &&
          schedule == o.schedule &&
    ...
    def hash
      [id, job_name, job_kind, job_parameters, schedule, job_status, deleted, creation_time, update_time].hash
    end
