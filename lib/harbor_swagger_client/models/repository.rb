...
module SwaggerClient
  class Repository
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'artifact_count')
        self.artifact_count = attributes[:'artifact_count']
      end
    ...
    def hash
      [id, project_id, name, description, artifact_count, pull_count, creation_time, update_time].hash
    end
