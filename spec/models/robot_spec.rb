...
# Unit tests for SwaggerClient::Robot
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Robot' do
  before do
    # run before each test
    @instance = SwaggerClient::Robot.new
  end
  ...
  describe 'test an instance of Robot' do
    it 'should create an instance of Robot' do
      expect(@instance).to be_instance_of(SwaggerClient::Robot)
    end
  end
